...
Glasspot charges a fee on every contribution and every payout/refund, always added on top so the pool amount everyone agreed on is never quietly shaved down.

- **Contribution**: Nomba's real cost (1% of the intended amount, floored at ₦10, capped at ₦150) plus a flat ₦10 platform cut, added on top of the amount the contributor intends to give. If someone means to contribute ₦10,000, they send ₦10,110 total (₦100 Nomba + ₦10 platform), and the pot is credited the full ₦10,000.
- **Payout/refund**: a flat ₦50 fee (₦20 Nomba + ₦30 platform), added on top of the amount the recipient is meant to receive. If a payout of ₦10,000 is requested, the pot's balance is debited ₦10,050, and the recipient gets the full ₦10,000.
