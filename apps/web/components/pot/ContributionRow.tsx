  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3">
      <div className="min-w-0">
        ...
        {contribution.status === "underpaid" ? (
          <Text size="xs" color="secondary">
            Paid <Money naira={contribution.paidAmount} size="xs" color="secondary" /> of{" "}
            <Money naira={contribution.expectedAmount} size="xs" color="secondary" />
          </Text>
        ) : (
          <Text size="xs" color="secondary">
      ...
      <div className="flex shrink-0 flex-col items-end gap-1">
        <Money naira={contribution.expectedAmount} className="font-medium" />
