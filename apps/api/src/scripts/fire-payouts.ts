/**
 * One-off recurring/rotation payout firing runner — invoke manually or
...
const rotation = await PayoutSchedulerService.fireDueRotationLegs();
console.log(`Rotation legs: ${rotation.fired} fired, ${rotation.skipped} skipped`);
