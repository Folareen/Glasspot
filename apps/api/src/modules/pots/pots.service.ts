 ...
 * recurring/rotation, this path always disburses everything currently in
 ...
 * which passes a FIXED amount for recurring/rotation.
 *
 ...
 * fired, advance a recurring config's nextRunAt, or mark a rotation leg
